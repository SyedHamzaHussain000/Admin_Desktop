      ...
      <div style={{ display: 'flex' }}>
        ...
        >
          <div style={{ height: '220px', width: '100%' }}>
            <img
              src={`${baseURL}public/Profiles/${userData.coverPic}`}
              style={{
                objectFit: 'cover',
                height: '150px',
                background: 'green',
          ...
          <div>
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                marginTop: 10,
                background: selectedButton == 'Profile' ? '#8D1F20' : null,
              }}
            >
              <img
                src={Profile_icon}
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                marginTop: 10,
                background: selectedButton == 'AddUsers' ? '#8D1F20' : null,
              }}
            >
              <img
                src={person}
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                marginTop: 10,
                background: selectedButton == 'Client' ? '#8D1F20' : null,
              }}
            >
              <img
                src={client_icon}
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                marginTop: 10,
                background: selectedButton == 'REPORTS' ? '#8D1F20' : null,
              }}
            >
              <img
                src={report_icon}
              ...
              <p
                style={{
                  fontSize: 14,
                  marginLeft: 10,
                  color: selectedButton == 'REPORTS' ? 'white' : 'black',
                }}
              >
                REPORTS
              </p>
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                marginTop: 10,
                background: selectedButton == 'Setting' ? '#8D1F20' : null,
              }}
            >
              <img
                src={setting_icon}
              ...
              <p
                style={{
                  fontSize: 14,
                  marginLeft: 10,
                  color: selectedButton == 'Setting' ? 'white' : 'black',
                }}
              >
                SETTINGS
              </p>
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                marginTop: 10,
                background: selectedButton == 'Logout' ? '#8D1F20' : null,
              }}
            >
              <img
                src={logout_icon}
              ...
              <p
                style={{
                  fontSize: 14,
                  marginLeft: 10,
                  color: selectedButton == 'Logout' ? 'white' : 'black',
                }}
              >
                LOG OUT
              </p>
